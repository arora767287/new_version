...
//  }
        ...
        const value = AsyncStorage.getItem('userInfo')
            .then((value) => {
              ...
              // console.log(value);
               ...
               console.log(JSON.parse(value).verification_id) 
               this.setState({
               ...
               console.log("User IDDDDDDDDDDD: ", JSON.parse(value).id);
    ...
    //     AsyncStorage.removeItem('userInfo'); BackHandler.exitApp() ;
 ...
 // check Kyc
    ...
    cancelWallet = () => {
     ...
     getListCategories = () => {
       console.log("User IDDDDDDDDD: ", this.state.userData.id);
       getFolderPercent(this.state.userData.id).then((folderPercents) => {
           ...
           console.log("currListCategoriessssssssssss", currListCategories);
           var currListTags = [];
   ...
   getGeneralOffer = () => {
    ...
    _renderItem({ item, index }) {    // coursel
        return (
            ...
            <View style={{...customstyles.filterContainer, display: "flex", flexDirection: "column", backgroundColor: '#662397', width: 150, height: 110, borderRadius: 16, padding: 10, margin: 10, opacity: 0.75}} key={index}>
                ...
                <View style={{backgroundColor: "#371252", alignSelf: "center", justifyContent: "center", alignItems: "center", width: 40, height: 40, borderRadius: 10}}>
                    <Text style={{...customstyles.h5, fontSize: 15, fontWeight: "normal", color: "white"}}>
                        ${item.data_share_price + item.open_to_contact_price}
                    </Text>
                </View>
            </View>
...
//import AppLoading from 'expo-app-loading';
    render() {
        return (
                <SafeAreaView style={[styles.scrollArea, {display: 'flex', flex: 1, backgroundColor: "yellow"}]}>
                      <Provider>
                        <View style={customstyles.header}>
                            <Text style={{...customstyles.titleText, fontSize: 35, color: "#fff", fontWeight: 'bold', flex: 1, marginLeft: 15}}>My Profile</Text>
                            <Menu
                          ...
                          { this.state.userData.current_location!=1  &&   
                                ...
                                <Menu.Item onPress={this.getcouponlist} title="Coupon" style={{ borderColor: "#ddd", borderBottomWidth: 1, }} />
         ...
         />
                        <ModelAlert
         Alert_Visibility={this.state.closestatus}
         cancelAlertBox={this.closeapp}
         title={"Close"}
         body={"Are you sure you want to Close?"}
         confirmalert={this.confirmclose}
         />
                    <ModelAlert
                            ...
                            <View style={[customstyles.p5, customstyles.lightbox, { width: "48%"}]}>
                                {/*<TouchableOpacity onPress={this.onPressInfo} style={[storeStyle.widgetStore]}>*/}
                                    ...
                                    <Text style={{color: "#662397", fontSize: 10, textAlign: "center", padding: 5}}>Upload more documents for easy access!</Text>
                                     <ScrollView horizontal={true} persistentScrollbar style={{display: "flex", flexDirection: "row", backgroundColor: "transparent", borderRadius: 16, margin: 2}}>
                                                            ...
                                                            <View style={{padding: 10}}>
                                       {
                                        ...
                                        <View style={{display: "flex", flexDirection: "row"}}><Text> <TouchableOpacity style={[customstyles.btnThemexs, {marginTop: 25}]} onPress={this.onPressAdd} >
                       ...
                       <View style={{...customstyles.filterContainer, display: "flex", flexDirection: 'column',  width: "48%"}}>
                           ...
                           <TouchableOpacity onPress={this.onPressOffer} style={{display: "flex", flexDirection: "column"}}>
                               <Carousel
                                   ...
                                   loop={true}
                                   vertical={true}
                                   onSnapToItem={index => this.setState({ activeIndex: index })} /></TouchableOpacity>
